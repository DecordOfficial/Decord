# Decord (Fork From Vencord & Equicord)
...
-   Easy to install
-   100+ built in plugins From Both Vencord & Equicord and other from Decord
-   Fairly lightweight despite the many inbuilt plugins
-   Excellent Browser Support: Run Decord in your Browser via extension or UserScript
...
| :------------------------------------------------------------------------------------------: |
|     **Thanks a lot to all Decord [sponsors](https://github.com/sponsors/DecordOfficial)!!**     |
| :------------------------------------------------------------------------------------------: |
